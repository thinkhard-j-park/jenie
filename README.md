...
| app                                           | protocol  | pod resource | virtual thread | iter/s | req/s   | avg     | p95 | p99      |
|:----------------------------------------------|:----------|:-------------|:---------------|:-------|:--------|:--------|:----|:---------|
| jenie-spring-helloworld-rest                  | rest      | 1 core, 1 Gi | -              | 250    | 754     | 109 ms  | 250 ms | 353 ms   |
| jenie-spring-helloworld-rest                  | rest      | 1 core, 1 Gi | enabled        | 280    | 840     | 5 ms    | 6 ms   | 61 ms    |
| jenie-spring-helloworld-rest-reactive         | rest      | 1 core, 1 Gi | -              | 210    | 630     | 193 ms  | 526 ms | 840 ms   |
| jenie-spring-helloworld-rest                  | rest      | 2 core, 2 Gi | -              | 490    | 1460    | 54 ms   | 154 ms | 188 ms   |
| jenie-spring-helloworld-rest                  | rest      | 2 core, 2 Gi | enabled        | 550    | 1650    | 3.9 ms  | 5 ms   | 28 ms    |
| jenie-spring-helloworld-rest-reactive         | rest      | 2 core, 2 Gi | -              | 480    | 1420    | 75 ms   | 229 ms | 424 ms   |
...
| app                                           | protocol  | pod resource | virtual thread | iter/s | req/s   | avg     | p95 | p99      |
|:----------------------------------------------|:----------|:-------------|:---------------|:-------|:--------|:--------|:----|:---------|
| jenie-spring-helloworld-armeria-grpc          | grpc      | 1 core, 1 Gi | -              | 290    | 880     | 140 ms  | 393 ms | 527 ms   |
| jenie-spring-helloworld-armeria-grpc          | grpc      | 1 core, 1 Gi | enabled        | 270    | 800     | 244 ms  | 891 ms | 1120 ms  |
| jenie-spring-helloworld-armeria-grpc-reactive | grpc      | 1 core, 1 Gi | -              | 290    | 860     | 255 ms  | 698 ms | 883 ms   |
| jenie-spring-helloworld-grpc                  | grpc      | 1 core, 1 Gi | -              | 290    | 850     | 236 ms | 515 ms | 799 ms   |
| jenie-spring-helloworld-grpc                  | grpc      | 1 core, 1 Gi | enabled        | 290    | 850     | 358 ms | 757 ms | 884 ms   |
| jenie-spring-helloworld-armeria-grpc          | grpc      | 2 core, 2 Gi | -              | 590    | 1780    | 100 ms  | 209 ms | 286 ms   |
| jenie-spring-helloworld-armeria-grpc          | grpc      | 2 core, 2 Gi | enabled        | 630    | 1910    | 181 ms  | 405 ms | 521 ms   |
| jenie-spring-helloworld-armeria-grpc-reactive | grpc      | 2 core, 2 Gi | -              | 560    | 1690    | 26 ms   | 90 ms  | 109 ms   |
| jenie-spring-helloworld-grpc                  | grpc      | 2 core, 2 Gi | -              | 670    | 1970  | 150 ms | 387 ms | 515 ms   |
| jenie-spring-helloworld-grpc                  | grpc      | 2 core, 2 Gi | enabled        | 670    | 1950  | 164 ms | 397 ms | 529 ms   |
