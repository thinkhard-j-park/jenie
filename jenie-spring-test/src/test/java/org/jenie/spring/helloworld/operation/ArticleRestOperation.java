...
import org.jenie.spring.client.RestOperation;
...
public class ArticleRestOperation extends RestOperation implements ArticleOperation {

	public ArticleRestOperation(RestClient restClient) {
		super(restClient);
	}
